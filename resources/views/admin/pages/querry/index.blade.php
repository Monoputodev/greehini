                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Phone</th>
                                        <th>Messege</th>
                                        <th class="bg-primary text-light">Attachment</th>
                                        <th>Posted at</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $querry->name }}</td>
                                        <td>{{ $querry->email }}</td>
                                        <td class="bg-danger text-light">{{ $querry->product->title }}</td>
                                        <td>{{ $querry->phone }}</td>
                                        <td>{{ $querry->comment }}</td>
                                        <td class="bg-primary"><a class=" text-light" href="{{ asset('uploads/clients/attachment/' . $querry->file) }}" download="{{ $querry->file }}"> Download Attachment</a></td>

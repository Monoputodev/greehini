...
<div class="col-md-6">
                                        <label for="image" class="form-label">Website Footer Logo</label>
                                        <input type="file" class="form-control dropify" id="image" name="website_footer_logo"
                                          data-default-file="{{ asset('uploads/content/' . $content->website_footer_logo) }}">
                                    </div>
                                    <div class="col-md-6">
